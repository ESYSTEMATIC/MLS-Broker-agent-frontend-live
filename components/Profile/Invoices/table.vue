  ...
  <div class="t-table">
    ...
    <div>
      ...
      >
        ...
        <div class="cell flex w-[10%] items-center justify-center">
          <button
            @click="showModal(idx + 1)"
            class="flex size-14 items-center justify-center rounded-full bg-[#CE11271A] opacity-0 transition-all group-hover:opacity-100"
          >
            <img src="/profile/icons/red-eye.svg" alt="show" />
          </button>
        </div>
      </div>
